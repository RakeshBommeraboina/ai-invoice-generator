    ...
    <section className="relative bg-[#fbfbfb] overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-32">
        <div className="text-center max-w-4xl mx-auto">
          <h1 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-black leading-tight mb-6">
            Effortless Invoicing Powered by AI
          </h1>
        ...
        <div className="mt-22 sm:mt-22 relative max-w-5xl mx-auto">
          <img
            src={HERO_IMG}
